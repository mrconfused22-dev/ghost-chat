    ...
    <div style={{
      ...
      <div style={{ maxWidth: '420px', width: '100%', position: 'relative', zIndex: 1 }}>
        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
          <div style={{ width: 'clamp(50px, 12vw, 80px)', height: 'clamp(50px, 12vw, 80px)', margin: '0 auto 0.75rem' }}>
            <img src="/ghost.png" style={{ width: '100%', height: '100%', objectFit: 'contain' }} />
          </div>
          <div style={{ fontSize: 'clamp(1.6rem, 7vw, 3rem)', fontWeight: 900, color: '#fff', fontFamily: 'Arial Black, Impact, sans-serif', letterSpacing: '0.06em', lineHeight: 1 }}>CHOOSE</div>
          <div style={{ fontSize: 'clamp(1.6rem, 7vw, 3rem)', fontWeight: 900, color: 'transparent', WebkitTextStroke: '2px #fff', fontFamily: 'Arial Black, Impact, sans-serif', letterSpacing: '0.06em', lineHeight: 1, marginBottom: '0.5rem' }}>YOUR NAME</div>
        ...
        <div style={{ border: '1px solid #222', borderRadius: '4px', padding: 'clamp(0.75rem, 3vw, 1rem)', marginBottom: '1.5rem', background: 'rgba(255,68,68,0.05)' }}>
          <p style={{ color: '#888', fontSize: 'clamp(0.78rem, 2.2vw, 0.82rem)', lineHeight: 1.6, textAlign: 'center' }}>
        ...
        <button onClick={handleSubmit} disabled={loading || !name.trim()}
          style={{
            width: '100%',
            background: name.trim() ? '#fff' : 'transparent',
            color: name.trim() ? '#000' : '#333',
            border: '2px solid ' + (name.trim() ? '#fff' : '#333'),
            padding: '1rem',
